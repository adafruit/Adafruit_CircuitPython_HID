...
"""
`adafruit_hid.keyboard_layout_us.KeyboardLayoutDvorak`
=======================================================

* Author(s): Dan Halbert, Jeremy Sullivan
"""

from .keycode import Keycode


class KeyboardLayoutDvorak:
    """Map ASCII characters to appropriate keypresses on Dvorak keyboard layout.

    Non-ASCII characters and most control characters will raise an exception.
    """

    # The ASCII_TO_KEYCODE bytes object is used as a table to maps ASCII 0-127
    # to the corresponding # keycode on a Dvorak 104-key keyboard layout.
    ...
    def __init__(self, keyboard):
        ...
        Example::
            ...
            layout = KeyboardLayoutDvorak(kbd)
        """
